...
# Prompt
parser.add_argument("--genre_txt", type=str,
...
parser.add_argument("--lyrics_txt", type=str,
...
offload.profile(pipe, profile_no=profile, quantizeTransformer=quantizeTransformer, compile=compile,
...
output_filename_base = f"tp{top_p}_T{temperature}_rp{repetition_penalty}_maxtk{max_new_tokens}_{random_id}".replace('.',
                                                                                                                    '@')
